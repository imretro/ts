...
import type { ColorList, TwoBitColors } from './index';
...
export default class TwoBitPalette extends Palette {
  ...
  constructor(
    arg1: Color | [Color, Color, Color, Color],
    light?: Color,
    strong?: Color,
    full?: Color,
  ) {
    super();
    if (arg1 instanceof Color && [light, strong, full].every((c) => c instanceof Color)) {
      this.colors = [arg1, light, strong, full] as TwoBitColors;
      return;
    }
    this.colors = arg1 as TwoBitColors;
  }
